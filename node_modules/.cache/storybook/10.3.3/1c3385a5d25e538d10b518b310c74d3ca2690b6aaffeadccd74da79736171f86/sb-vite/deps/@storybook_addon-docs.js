...
import { st as definePreviewAddon10 } from "./components-B3z-wx7s.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-CwEHs65F.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-DDLnbb5O.js");
